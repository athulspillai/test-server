...
const UserController = {
    RegisterUser: async (req, res) => {
        try {
            ...
            const { username, userid, password, email, mobilenumber, department, branches, forms, reports } = req.body;
            const image = req.file.path; // Path to the uploaded image

            // Create a new user
            const newUser = new User({ username, userid, password, email, mobilenumber, department, branches, forms, reports, image });
